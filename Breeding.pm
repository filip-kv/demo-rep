...
sub ImportBreedingAuth {
    ...
    my $controlnumber2 = $marcrecord->field('099')->data;
    ...
    # Filippos Kolovos -- If a record already exists, then update its MARC and MARCXML
    # in order for it to work in case there has been a change in the XSLT settings of the
    # AUTH Server
    if ($breedingid)
    {
...
sub Z3950SearchAuth {
    ...
    # Filippos Kolovos -- patch for manipulating auth records with XSLT
    my $xslh = Koha::XSLT::Base->new;
